...
<body>
	...
	<div class="w3-sidebar w3-bar-block w3-animate-left w3-light-grey"
		...
		<c:if test="${!empty sessionScope.login}">
          ...
          <a href="${path}/user/updatepw.jeju" class="w3-bar-item w3-button">비밀번호 변경</a> 
          <a href="#" class="w3-bar-item w3-button">포인트</a> 
          <a href="#" class="w3-bar-item w3-button">예약 내역</a> 
          <a href="#"	class="w3-bar-item w3-button">찜</a> 
          <a href="${path}/user/inquiry.jeju" class="w3-bar-item w3-button">1:1 문의 내역</a> 
          <a href="${path}/user/withdrawal.jeju" class="w3-bar-item w3-button">회원탈퇴 신청</a>
				</div>
			</div>
		</c:if>
		<c:if test="${sessionScope.login.userid=='admin'}">
			...
			<div class="w3-dropdown-hover">
				...
				<div class="w3-dropdown-content w3-bar-block">
					<a href="#" class="w3-bar-item w3-button">패키지 등록</a>
				</div>
			</div>
		</c:if>
	</div>
